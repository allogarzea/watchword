...
const bootstrap = (): void => {
	...
	program
		.addOption(
			new Option('-l, --length <value>', 'set the password length').default(
				recommendedValues.length.default
			)
		)
		.addOption(
			new Option(
				'-n, --numbers <value>',
				'set the minimum amount of numbers in the password'
			).default(recommendedValues.numbers.default)
		)
		.addOption(
			new Option(
				'-s, --special <value>',
				'set the minimum amount of special characters in the password'
